...
public class EnrollmentController {
    ...
    public ResponseEntity<EnrollmentDto.ApiResponse<EnrollmentDto.EnrollmentResponse>> enroll(
        ...
        EnrollmentDto.EnrollmentResponse response =
                enrollmentService.reserve(userId, request);
    ...
    /**
     * GET /enrollments/carrier/my - 수집·운반 업체의 접수 목록 조회
     */
    @GetMapping("/carrier/my")
    public ResponseEntity<EnrollmentDto.ApiResponse<List<EnrollmentDto.EnrollmentResponse>>> getCarrierRequests(
            @RequestHeader("X-User-Id") Long carrierId) {

        return ResponseEntity.ok(EnrollmentDto.ApiResponse.success(
                enrollmentService.getRequestsByCarrier(carrierId)));
    }
    ...
    public ResponseEntity<EnrollmentDto.ApiResponse<EnrollmentDto.EnrollmentResponse>> acceptRequest(
        ...
        return ResponseEntity.ok(EnrollmentDto.ApiResponse.success(
                enrollmentService.acceptRequest(id, carrierId)));
    }
    ...
    public ResponseEntity<EnrollmentDto.ApiResponse<EnrollmentDto.EnrollmentResponse>> rejectRequest(
        ...
        return ResponseEntity.ok(EnrollmentDto.ApiResponse.success(
                enrollmentService.rejectRequest(id, carrierId)));
    }
    ...
    public ResponseEntity<EnrollmentDto.ApiResponse<EnrollmentDto.EnrollmentResponse>> completeRequest(
        ...
        return ResponseEntity.ok(EnrollmentDto.ApiResponse.success(
                enrollmentService.completeRequest(id, carrierId)));
    }
