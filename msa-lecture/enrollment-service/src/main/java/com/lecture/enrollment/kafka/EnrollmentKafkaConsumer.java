...
public class EnrollmentKafkaConsumer {
    ...
    public void handlePaymentCompleted(Map<String, Object> event) {
        ...
        try {
            Object reservationIdValue = event.get("collectionRequestId");
            Object userIdValue = event.get("generatorId");
            Object courseIdValue = event.get("collectionServiceId");

            if (reservationIdValue == null || userIdValue == null || courseIdValue == null) {
                throw new IllegalArgumentException("Kafka 결제 이벤트의 수거 신청 정보가 누락되었습니다.");
            }

            Long reservationId = ((Number) reservationIdValue).longValue();
            ...
            enrollmentService.confirmReservation(reservationId, userId, courseId);
